...
//   // Determine direction labels based on line
...
//   let filteredTrains = data.filter(train => 
//     train.LINE.toLowerCase() === color.toLowerCase()
//   );
...
//     filteredTrains = filteredTrains.filter(train => {
//       if (filters.arriving && train.NEXT_ARR === 'Arriving') return true;
//       if (filters.scheduled && train.NEXT_ARR !== 'Arriving') return true;
//       return false;
//     });
//   }
...
//     filteredTrains = filteredTrains.filter(train => {
//       if (filters.direction1 && train.DIRECTION === direction1) return true;
//       if (filters.direction2 && train.DIRECTION === direction2) return true;
//       return false;
//     });
//   }
...
//           WAITING_SECONDS={train.WAITING_SECONDS}
